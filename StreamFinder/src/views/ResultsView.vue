    ...
    <div class="container mx-auto p-4 sm:p-6 max-w-full sm:max-w-xl">
      <header class="mb-12">
        <div class="text-center">
          ...
          <p v-if="store.selectedLeagueIds.length > 0" class="text-base sm:text-lg text-slate-700 dark:text-slate-300 mt-2 leading-relaxed">
      ...
      <main class="rounded-2xl bg-white/80 dark:bg-slate-700/80 border border-slate-200 dark:border-slate-700/50 pt-10">
        ...
        <div v-else-if="topPicks.length > 0 || otherOptions.length > 0">
          <section class="mb-10">
            <h2 v-if="topPicks.length > 0" class="text-2xl font-semibold text-slate-700 dark:text-slate-300 mb-2 text-center">Our Top Recommendations</h2>
        ...
        <div v-else class="text-center py-10 bg-slate-100/80 dark:bg-slate-800/50 backdrop-blur-sm p-6 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-700/50">
