  ...
  <div class="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
    <div class="container mx-auto p-4 sm:p-6 max-w-full sm:max-w-xl">
      <header class="mb-12 text-center">
        ...
        <h1 class="text-3xl sm:text-5xl font-bold bg-gradient-to-r from-blue-400 to-indigo-500 bg-clip-text text-transparent mb-4">StreamFinder</h1>
        <p class="text-base sm:text-lg text-slate-300 mt-2 max-w-lg mx-auto leading-relaxed">
