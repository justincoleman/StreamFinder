<template>
  <div
    ...
    :class="[
      ...
      (isSecondaryOption && service.isSubscribed) ? 'bg-gray-100 border-gray-300' : /* Muted for subscribed secondary */
      'border-gray-300 bg-white',
      // Primary recommendation badge theming
      {'border-2 border-purple-500 bg-purple-50 ring-purple-300': service.badge === 'Most Coverage' && isPrimaryRecommendation}, // This badge is no longer used
  ...
  >
    <div
      ...
      :class="{
        // 'bg-purple-500 text-white border-purple-600': service.badge === 'Most Coverage', // No longer used
    ...
    <div class="flex flex-col sm:flex-row justify-between sm:items-start mb-3 pt-4">
      <h3 class="text-xl font-bold mb-2 sm:mb-0"
          :class="[
            ...
            // {'text-purple-700': service.badge === 'Most Coverage' && isPrimaryRecommendation}, // No longer used
    ...
    <p class="text-md sm:text-lg text-gray-700 mb-1 pb-3 border-b"
       :class="{
        ...
        //  'border-purple-200': service.badge === 'Most Coverage' && isPrimaryRecommendation, // No longer used
